...
const get=async(req,res)=>{
    try{
        const resources=await Resource.find().populate([{path:'createdBy',select:'name email'},{path:'resourceavailabilityID',select:'name availableTime maxReserveTime reserveTimeInterval'}]);
